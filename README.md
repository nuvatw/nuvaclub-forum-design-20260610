# nuvaClub Forum Design 20260610

Standalone UI/UX mock for the nuvaClub forum sharing flow.

## Features

- 72 mock forum posts: 24 `貼文`, 24 `問問題`, 24 `里程碑`
- Composer flow with `貼文`, `問問題`, `里程碑`
